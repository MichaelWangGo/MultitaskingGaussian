...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, stage="fine"):
    ...
    # objects_dc_final[~deformation_point] = objects_dc[~deformation_point]

    scales_final = pc.scaling_activation(scales_final)
    rotations_final = pc.rotation_activation(rotations_final)
    opacity = pc.opacity_activation(opacity)
    # objects_dc = pc.objects_dc_activation(objects_dc)
    ...
    rendered_image, radii, depth, rendered_objects = rasterizer(
