...
def loss_cls_3d(features, predictions, k=5, lambda_val=2.0, max_points=200000, sample_size=800):
    """
    Compute the neighborhood consistency loss for a 3D point cloud using Top-k neighbors and the KL divergence.
    ...
    sample_features = features[indices] #features:torch.Size([30076, 3]) 
    sample_preds = predictions[indices] #predictions:torch.Size([30076, 256])
